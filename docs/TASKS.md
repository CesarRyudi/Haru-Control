...
- `[ ]` **[BUG-009]** Erro ao carregar previsão de fornada no modal por endpoint incorreto — *[🟡 Implementado: rota corrigida para /stock/baking-suggestion e inicialização síncrona de período — ⏳ Aguardando Validação Prática]*
